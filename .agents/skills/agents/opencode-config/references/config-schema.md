...
Use current frontier models: **glm-5**, **glm-5.1**, **qwen3.6-plus**, **kimi-k2.5**, **kimi-k2.6**, **MiniMax-M2.5**, **minimax-m2.7**.
</critical_warning>
...
```jsonc
{
  "model": "gt-litellm/glm-5",
  "small_model": "gt-litellm/qwen3.6-plus",
}
```
